...
export const ROUTE_METADATA: readonly RouteMetadata[] = [
  ...
  },
  {
    ...
    breadcrumbs: [
      ...
      { label: 'Utilizações', href: '/portal/redemptions' },
      { label: 'Comprovante' },
    ],
  },
  {
  ...
  },
  {
    ...
    capability: 'benefit_offers.read',
    breadcrumbs: [{ label: 'Portal', href: '/portal' }, { label: 'Utilizações' }],
  },
  {
  ...
  {
    id: 'portal-content',
    pattern: '/portal/content',
    surface: 'portal',
    title: 'Conteúdo do parceiro',
    description: 'Experiências, eventos e itens de vitrine das unidades da organização.',
    capability: 'establishments.read',
    breadcrumbs: [{ label: 'Portal', href: '/portal' }, { label: 'Conteúdo' }],
  },
  {
    id: 'portal-home',
    pattern: '/portal',
  ...
  {
    id: 'portal-organization-analytics',
    pattern: '/organizations/:organizationId/analytics',
    surface: 'portal',
    title: 'Analytics de descoberta',
    description: 'Alcance e ações públicas das unidades da organização.',
    capability: 'analytics.read',
    breadcrumbs: [
      { label: 'Portal', href: '/portal' },
      { label: 'Organização' },
      { label: 'Analytics de descoberta' },
    ],
  },
  {
    id: 'backoffice-content',
    pattern: '/backoffice/content',
    surface: 'backoffice',
    title: 'Conteúdo de parceiros',
    description:
      'Fila própria de experiências, eventos e itens de vitrine enviados pelos parceiros.',
    capability: 'establishments.list',
    breadcrumbs: [{ label: 'Conteúdo de parceiros' }],
    includeChildren: true,
  },
  {
  ...
  },
  {
    ...
    description: 'Limites e exigências que valem para as avaliações desta operação.',
    capability: 'settings.read',
    breadcrumbs: [{ label: 'Regras de avaliação' }],
  },
  {
    id: 'backoffice-concierge',
    pattern: '/backoffice/concierge',
    surface: 'backoffice',
    title: 'Concierge IA',
    description: 'Como o assistente de descoberta responde nesta operação.',
    capability: 'settings.read',
    breadcrumbs: [{ label: 'Concierge IA' }],
  },
  {
    id: 'backoffice-taxonomy',
    pattern: '/backoffice/taxonomy',
    surface: 'backoffice',
    title: 'Categorias',
    description: 'Famílias e categorias que organizam a descoberta.',
    capability: 'categories.list',
    breadcrumbs: [{ label: 'Categorias' }],
  },
  {
    id: 'backoffice-geography',
    pattern: '/backoffice/geography',
    surface: 'backoffice',
    title: 'Regiões e cidades',
    description: 'Onde a operação atua e em que fuso cada cidade vive.',
    capability: 'cities.list',
    breadcrumbs: [{ label: 'Regiões e cidades' }],
  },
  {
  ...
  },
  {
    ...
    description: 'Dados pessoais, aparência e segurança da sua conta.',
    breadcrumbs: [{ label: 'Conta e preferências' }],
    includeChildren: true,
  },
]
