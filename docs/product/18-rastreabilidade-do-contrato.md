...
| Interesses para personalização | Entregue | faixa "Para você" em Explorar com os lugares descobríveis da cidade nas categorias escolhidas, na ordem neutra da busca sem termo, sem vaga de patrocínio; a busca orgânica não muda — reordenar a descoberta por interesse segue pendente do contratante (ADR-0030, revisão de 26/09/2026) |
...
| Informações do catálogo e do Concierge                  | Entregue | catálogo por tela; Concierge em `/backoffice/concierge`: ligar por operação, itens do catálogo por pergunta e perguntas por pessoa por dia (valores provisórios até o item 15), com a infraestrutura só para leitura e sem expor a chave (ADR-0029, revisão de 26/09/2026) |
